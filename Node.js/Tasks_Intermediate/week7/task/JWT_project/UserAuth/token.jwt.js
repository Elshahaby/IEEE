...
export async function verifyRefreshToken(refreshToken) {
  try {
    ...
    if(storedToken === refreshToken){
      ...
      // explain for third point in console: inside the function I throw a string and this throw part go to catch part whit in his turn throw unauthorized to the route that the function called in it, so what ever you throw inside function it will send unauthorized to the route
